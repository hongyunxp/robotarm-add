 ...
 *
 */
public class ConsumeAlipayWap extends Activity implements OnClickListener {
	...
	private void initView() {
		...
		mWebView.setWebViewClient(new WebViewClient() {
			...
			public void onPageStarted(WebView view, String url, Bitmap favicon) {
				...
				if (pd != null)
					pd.cancel();
				pd = ViewUtils.progressLoading(ConsumeAlipayWap.this);
			}
		...
		mWebView.loadUrl(String.format(Constants.ALIPAY_WAP_URL, uid, fee));
	}
