 ...
 * 
 */
public class MusicCoverActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 创建任务
		task = new CoverSyncTask(this, MokoClient.MUSIC);
	}
	...
	public void clickImage(View view) {
		...
		tabInvHandler.startSubActivity(R.id.tab_music, MusicContentActivity.class, mBundle);
	}
