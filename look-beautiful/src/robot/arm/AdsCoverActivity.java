 ...
 * 
 */
public class AdsCoverActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 创建任务
		task = new CoverSyncTask(this, MokoClient.ADS);
	}
	...
	public void clickImage(View view) {
		...
		tabInvHandler.startSubActivity(R.id.tab_ads, AdsContentActivity.class, mBundle);
	}
