...
import robot.arm.provider.parser.annotation.BooleanFormat;
 ...
 * 
 * 
 * @author wanglin(lin3.wang@changhong.com) 2012-5-14下午6:58:00
 */
	...
	public static void storeValue(final JSONObject jsonObject,
		...
		if (clzTypeKeyMap.containsKey(classType)) {
			...
			case TYPE_DATE:
				...
				if (field
						.isAnnotationPresent(robot.arm.provider.parser.annotation.DateFormat.class)) {
					robot.arm.provider.parser.annotation.DateFormat formatAnnotation = field
							.getAnnotation(robot.arm.provider.parser.annotation.DateFormat.class);
